...
Unsure about accessing directory structures at the command line? Take a course on [Unix](http://bioinformatics-core-shared-training.github.io/shell-novice/)
...
- Read the file `gapminder.csv` using the `read.csv` function and save the result as a variable
...
In the year 2002, was there a significant different in the life expectancies of European and African countries in the Year 2002?
  - Use the data in `euroData` and `afrData` to find out
  - First subset `euroData` and `afrData` to contain only information for the year 2002
